    ...
    <script>
        ...
        function renderSummary() {
            ...
            const buyerHtml = `
                ...
                ${buyer.delivery_destination ? `<p><span class="font-semibold text-[var(--ink)]">Tujuan terjadwal:</span>
                    ${buyer.delivery_destination}</p>` : ''}
                <p><span class="font-semibold text-[var(--ink)]">Jadwal:</span>
                    ${buyer.shipping_date || '-'} ${buyer.shipping_time || ''}</p>
                ${buyer.note ? `<p><span class="font-semibold text-[var(--ink)]">Catatan:</span>
                    ${buyer.note}</p>` : ''}
                <p><span class="font-semibold text-[var(--ink)]">Order ID:</span>
                    ${orderId}</p>
            `;
